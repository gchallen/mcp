...
describe("EverythingAuthProvider", () => {
  ...
  describe("challengeForAuthorizationCode", () => {
    ...
    it("throws error for non-existent authorization code", async () => {
      ...
      await expect(provider.challengeForAuthorizationCode(client, "test-code")).rejects.toThrow(
    ...
    it("throws error when client ID doesn't match", async () => {
      ...
      await expect(provider.challengeForAuthorizationCode(client, authCode)).rejects.toThrow(
  ...
  describe("exchangeAuthorizationCode", () => {
    ...
    it("throws error for invalid authorization code", async () => {
      ...
      await expect(provider.exchangeAuthorizationCode(client, "test-code")).rejects.toThrow(
  ...
  describe("exchangeRefreshToken", () => {
    it("returns new tokens when refresh token is valid", async () => {
      const { client, accessToken, mcpInstallation } = getMockAuthValues()
    ...
    it("throws error for invalid refresh token", async () => {
      ...
      await expect(provider.exchangeRefreshToken(client, "test-refresh-token")).rejects.toThrow("Invalid refresh token")
    })
    ...
    it("throws error for refresh token with no installation", async () => {
      ...
      await expect(provider.exchangeRefreshToken(client, refreshToken)).rejects.toThrow("Invalid refresh token")
    })
    ...
    it("throws error when client ID doesn't match", async () => {
      ...
      await expect(provider.exchangeRefreshToken(client, refreshToken)).rejects.toThrow("Invalid client")
    })
    ...
    it("works correctly even when the refresh token has expired from Redis", async () => {
      ...
      await expect(provider.exchangeRefreshToken(client, "expired-refresh-token")).rejects.toThrow(
  ...
  describe("verifyAccessToken", () => {
    ...
    it("throws InvalidTokenError for expired token", async () => {
      ...
      await expect(provider.verifyAccessToken(accessToken)).rejects.toThrow(InvalidTokenError)
    })
  })
