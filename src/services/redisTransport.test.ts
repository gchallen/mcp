...
describe("Redis Transport", () => {
  ...
  describe("ServerRedisTransport", () => {
    ...
    it("should send response messages to request-specific channels", async () => {
      ...
      await mockRedis.createSubscription(`mcp:shttp:toclient:${sessionId}:123`, mockSubscriber, jest.fn())
    ...
    it("should send notification messages to notification channel", async () => {
      ...
      const mockSubscriber = jest.fn()
      await mockRedis.createSubscription(`mcp:shttp:toclient:${sessionId}:__GET_stream`, mockSubscriber, jest.fn())
    ...
    it("should receive MCP messages from clients and call onmessage", async () => {
      ...
      expect(onMessageMock).toHaveBeenCalledWith(clientMessage, {
  ...
  describe("redisRelayToMcpServer", () => {
    ...
    it("should set up message relay from transport to server", async () => {
      ...
      await mockRedis.createSubscription(`mcp:shttp:toserver:${sessionId}`, serverSubscriber, jest.fn())
  ...
  describe("isLive", () => {
    ...
    it("should return true when session has active subscribers", async () => {
      ...
      await mockRedis.createSubscription(`mcp:shttp:toserver:${sessionId}`, jest.fn(), jest.fn())
  ...
  describe("Control Messages", () => {
    ...
    it("should send shutdown control messages", async () => {
      ...
      await mockRedis.createSubscription(`mcp:control:${sessionId}`, controlSubscriber, jest.fn())
